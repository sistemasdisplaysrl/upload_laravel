...
@section('content')
    <div class="page-heading">
        <h3>Creacion de un nuevo Cargo</h3>
    </div>
    <hr>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="nro_coorporativo" id="nro_coorporativo" class="form-control" required>
                                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="usuario_telegram" id="usuario_telegram" class="form-control" required>
                                    </div>
